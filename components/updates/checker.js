...
function vigiarColecaoUpdates() {
    ...
    unsubscribeUpdates = onSnapshot(q, (snapshot) => {
...
function exibirPopupAtualizacao(docId, data, corSistema) {
    ...
    popup.innerHTML = `
        <div style="background: ${corFundoCard}; background-image: linear-gradient(90deg, rgba(15,23,42,0.98) 0%, rgba(15,23,42,0.94) 50%, rgba(15,23,42,0.42) 100%), url(&quot;components/assets/notebook-updates-popup-bg.png&quot;); background-size: cover; background-position: center; border: 1px solid rgba(255,255,255,0.1); border-radius: 16px; padding: 20px; min-height: 280px; max-width: 440px; width: 100%; max-height: calc(100vh - 40px); overflow-y: auto; box-shadow: 0 10px 25px rgba(0,0,0,0.5); display: flex; flex-direction: column; gap: 15px; box-sizing: border-box; -webkit-overflow-scrolling: touch;">
