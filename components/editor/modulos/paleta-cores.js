...
const PALETTE_TAB_FEATURES = {
    'tab-destaques': 'personalizacao_destaques',
    'tab-focos': 'personalizacao_focos',
    'tab-mutacao': 'personalizacao_mutacao',
    'tab-fundir': 'personalizacao_fundir'
};

async function permitirAbaPaleta(targetId) {
    const featureKey = PALETTE_TAB_FEATURES[targetId];
...
export async function abrirPaleta(caixaAlvo, abaAlvo = "tab-destaques", callbackTemporario = null, opcoes = {}) {
    ...
    if (!(await permitirAbaPaleta(abaAlvo))) abaAlvo = 'tab-destaques';
