...
import { aplicarModoMinimal } from './minimal-mode.js';
...
export const SyncManager = {
    atualizar: async (state, acionarGravacao, dispararGravacao = true) => {
        ...
        const configNota = obterConfigNota(state.dadosNotaOriginal, uid);
        aplicarModoMinimal(modosAtivos, configNota.minimalEclipse);
