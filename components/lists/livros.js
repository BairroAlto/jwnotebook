...
p.onclick = (e) => {
    ...
    if (dataPai.artigos) {
        // 🚀 CORREÇÃO: Usar 'obj' (o artigo atual) e não 'artigos[0]' (o primeiro da revista)
    ...
    console.log(`%c👈 [ESQUERDA] Clicou em: ${refParaProcessar} | Parágrafo: ${bloco.numero_ref}`, "color: #fbbf24; font-weight: bold;");
    ...
    import('../biblioteca-brain/biblio-bridge.js').then(m => {
        m.estudarReferencia({
            ...
            // 🚀 ADICIONADO: Enviar o título do artigo para reforçar a unicidade
