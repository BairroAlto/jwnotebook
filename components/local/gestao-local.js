...
function configurarCliquesPopup() {
 ...
 btnTop.onclick = async () => {
        ...
        const isTopAtivo = itemAtual.dados.Top?.estado === "on";
        ...
        try {
            ...
            if (novoEstado === "on") {
                ...
                const qTop = query(collection(db, "Local"), where("userId", "==", uid), where("Top.estado", "==", "on"));
            ...
            btnTop.classList.toggle('pin-ativo', novoEstado === "on");
...
window.abrirEditorItemLocal = async (id, tipo, nome) => {
    ...
    try {
        ...
        btnTop.classList.toggle('pin-ativo', itemAtual.dados.Top?.estado === "on");
        ...
        btnTop.onclick = async (e) => {
            ...
            const isTopAtivo = itemAtual.dados.Top?.estado === "on";
            const novoEstadoTop = isTopAtivo ? "off" : "on";
            ...
            try {
                ...
                btnTop.classList.toggle('pin-ativo', novoEstadoTop === "on");
